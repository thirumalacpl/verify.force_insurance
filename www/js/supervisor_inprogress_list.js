...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/seen.php?user_ida="+user_ida+"&qualification_id="+qualification_id+"&subco_statuss="+subco_statuss,
  data: formData,
  async: 'true',
  crossDomain: true,
  dataType: 'json',
