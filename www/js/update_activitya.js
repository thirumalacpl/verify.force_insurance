...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/delete.php?del_id="+del_id,
...
$.ajax({
  type: "POST",
url: "http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/sdoc.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&res="+res+"&qualification_id="+qualification_id+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/lifeint.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&qualification_id="+qualification_id+"&inte="+inte+"&inte_rat="+inte_rat+"&beh="+beh+"&beh_rat="+beh_rat+"&hab="+hab+"&hab_rat="+hab_rat,
...
// $('#myPopupr').hide();
$.ajax({url: 'http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/count.php?region='+region+"&user_id="+user_id+"&state="+state,
