...
//alert(region+'region');
$.ajax({url: 'http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/dash_completeda.php?',
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'inprogress');
//alert(region+'region');
$.ajax({url: 'http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/dash_await.php?',
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'inprogress');
//alert(region+'region');
$.ajax({url: 'http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/dashinprogressa.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
var app = {
	...
	//alert(region+'region');
		//alert(user_id+'user_id');
 $.ajax({url: 'http://staging.eimpressive.com/slim_force/slim_four_ripsssjs/gcm_id_user.php?gcm_regid='+gcm_regid+"&E_Mail="+E_Mail+"&username="+username+"&region="+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
